...
trait Userstamps
{
    ...
    {
        static::creating('App\Data\Userstamps\Listeners\Creating@handle');
        static::updating('App\Data\Userstamps\Listeners\Updating@handle');

        if (static::usingSoftDeletes()) {
            static::deleting('App\Data\Userstamps\Listeners\Deleting@handle');
            static::restoring('App\Data\Userstamps\Listeners\Restoring@handle');
        }
    }
