...
class CreatePaymentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->decimal('billAmount', 10, 3);
            $table->decimal('paidAmountInBillCurrency', 10, 3);
            $table->decimal('paidAmountInSecondCurrency', 10, 3);
            ...
            $table->decimal('billAmountInTjs', 10, 3)->nullable();
            $table->char('exchange_rate_to_tjs', 26)->nullable();
            $table->decimal('clientDebt', 10, 3)->nullable();
