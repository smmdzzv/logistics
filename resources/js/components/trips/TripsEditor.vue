                ...
                <div class="card shadow mb-5">
                    ...
                    <div class="card-body">
                        <form @submit.prevent id="addTripForm">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label text-md-right" for="carId">Поставщик
                                    машины</label>
                                <div class="col-md-6">
                                    <select class="form-control custom-select" v-model="selectedCarProvider">
                                        <option v-for="provider in carProviders" :key="provider.id" :value="provider">
                                            {{ provider.name }}
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="invalid-feedback" role="alert"
                                        ...
                                        <strong>Необходимо ввести длину маршрута в км</strong>
                                        <strong
                                            v-for="message in errors.routeLengthToDestination">{{ message }}</strong>
                                    </span>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 col-form-label text-md-right" for="otherExpanses">Прочие
                                    расходы</label>
                                <div class="col-md-6">
                                    <b-form-input
...
export default {
    ...
    watch:{
        selectedCarProvider(){
            var vm = this;
            this.filteredCars = this.cars.filter(function (car) {
                return car.car_provider_id && car.car_provider_id  === vm.selectedCarProvider.id
            });
        }
    },
    components: {
