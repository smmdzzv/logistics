        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="addItem" method="POST" action="{{route('items.update', $item->id)}}">
                            @csrf
                            @method('patch')
                            ...
                            <div class="form-group row">
                                <label for="customsCodes" class="col-md-4 col-form-label text-md-right">Таможенные
                                    коды</label>
                                <div class="col-md-6">
                                    <select id="customsCodes" name="customsCodes[]"
                                        ...
                                        @foreach($customsCodes as $code)
                                            <option value="{{$code->id}}"
                                                    @if( old('customsCodes') && in_array($code->id, old('customsCodes'))
                                                        || in_array($code->id, $item->codes->pluck('id')->toArray())) selected @endif>
                                                {{$code->name}}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div id="onlyCustomPrice" class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" name="onlyCustomPrice"
                                                   @if(old('onlyCustomPrice') ?? $item->onlyCustomPrice) checked @endif
                                                   value="1"
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" name="onlyAgreedPrice"
                                                   @if(old('onlyAgreedPrice')  ?? $item->onlyAgreedPrice)checked @endif
                                                   value="1"
                                                   aria-label="Radio button for following text input">
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="input-group offset-md-2 col-md-6">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" name="calculateByNormAndWeight"
                                                   @if(old('calculateByNormAndWeight')  ?? $item->calculateByNormAndWeight)checked
                                                   @endif
                                                   value="1"
                                                   aria-label="Radio button for following text input">
                                        </div>
                                    ...
                                    <input type="text"
                                           class="form-control @error('calculateByNormAndWeight') is-invalid @enderror"
                                           aria-label="Text input with radio button"
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" name="applyDiscount"
                                                   @if(old('applyDiscount')  ?? $item->applyDiscount)checked @endif
                                                   value="1"
                                                   aria-label="Radio button for following text input">
                                        </div>
                                    </div>
